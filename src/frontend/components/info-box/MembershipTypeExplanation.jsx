    ...
    return (
      <div>
        ...
        <Modal
          ...
          contentLabel="Membership Types"
          style={customStyles}>
          <div className='modal-header'>
            <a className="clickable" href="javascript:void(0)"><img src='/images/close_button.svg' onClick={this.closeModal} className='close_button'/></a>
