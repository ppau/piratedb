  ...
  render() {
    return (<div className="info-box">
      ...
      <div className="info-body">
        Permanent residents can do the following, except where unable to exercise those privileges which cannot be
        granted due to relevant federal, state or territory legislation:
        <ul>
