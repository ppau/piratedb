  ...
  calculateMembershipType() {
    ...
    if (this.refs.isEnrolledYes.checked) {
      if (this.refs.citizen.checked) {
        ...
        this.setState({errors: ["Only Australian citizens can be enrolled to vote in Australia"], showInfoBox: false})
      }
    } else if (this.refs.isEnrolledNo.checked) {
      if (this.refs.citizen.checked) {
        this.setState({
          errors: ["Australian citizens must be enrolled to become a member", "You must be at least 16 years of age to sign up as a Pirate Party member"],
          showInfoBox: false
        })
    ...
    return (<fieldset>
      ...
      <div className="form-body">
        ...
        <div className="heading">
          ...
          <div className="sub-description">We will use your answers to determine which Pirate Party membership suits you
            best.
          </div>
        </div>
        ...
        <div className="navigation">
          <button className="nav-button" onClick={this.validateQuestionsAnswered}>Continue</button>
        </div>
      </div>
    </fieldset>)
  }
